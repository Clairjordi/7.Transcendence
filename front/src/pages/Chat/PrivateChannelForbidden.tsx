export const PrivateChannelForbidden = () => {
                            ...
                            <div className="max-w-md mx-auto">
                                <div className="flex items-center space-x-5">
                                    ...
                                    <div className="block pl-2 font-semibold text-xl self-start text-gray-700">
                                        <p className="leading-relaxed text-white mt-2">Forbidden</p>
                                    </div>
                                </div>
                                <div className="divide-y divide-gray-200">
                                    <div className="py-4 text-base mt-2 leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                        <div className="flex flex-col">
                                            <label className="leading-loose text-white">You must have an invitation to join this channel </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
