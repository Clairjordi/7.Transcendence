...
const SetPasswordChanExist: React.FC<PopupPasswordProps> = ({ socketChat, chanNameForSetPassword, setChanNameForSetPassword, onClose }) => {
    ...
    const clickDone = () => {
        if (password === '')
            return;
        socketChat.emit('setPassword', {chanName: chanNameForSetPassword, password: password});
                                ...
                                <div className="divide-y divide-gray-200">
                                    <div className="py-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                        <div className="flex flex-col">
                                            <label className="leading-loose text-white mb-1">Choose the new Password of the channel: {chanNameForSetPassword}</label>
...
export default SetPasswordChanExist
